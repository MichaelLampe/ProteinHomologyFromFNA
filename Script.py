	...
	def produce_final_fasta(self, hammer_result_file, final_fasta_file):
		...
		with open(hammer_result_file, "r") as results:
			...
			for line in results:
				...
				if collect:
					sequence_name = float(line.split("NM_")[1].split(" ")[0])
		...
		matching_sequences = ["NM_" + str(s) for s in matching_sequences]
...
if __name__ == "__main__":
	...
	hammer_location = "hammer/hmmer-3.1b2-linux-intel-x86_64/binaries/hmmsearch"
